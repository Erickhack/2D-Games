...
export const PuzzleStartMessage: React.FC<PuzzleStartMessageProps> = ({
  ...
  return (
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20 bg-white bg-opacity-90 rounded-lg p-8 text-center shadow-xl">
      <h2 className="text-2xl font-bold text-blue-500 mb-4">Готовы начать?</h2>
